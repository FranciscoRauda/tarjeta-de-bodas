  ...
  return (
    <section className="bg-[#fffdfc] px-4 pb-12 pt-4">
      ...
      <ol className="relative mt-8">
        <span className="absolute bottom-3 left-1/2 top-3 w-px -translate-x-1/2 bg-[#d4af37]" />
          ...
          return (
            ...
            >
              ...
              <div className="flex justify-center">
                <span className="relative z-10 h-3 w-3 rounded-full bg-[#d4af37] ring-4 ring-white" />
              </div>
              <div>
                {!left ? (
                  <EventBlock
